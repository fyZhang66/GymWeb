...
async def run_test():
    ...
    try:
        ...
        # -> Type 'not-a-user@example.com' into the email field (index 9) then type 'wrong-password' into the password field (index 10) and click the 'Sign In' button (index 13).
