...
async def run_test():
    ...
    try:
        ...
        # -> Type the member email into the email field (index 9).
        ...
        # -> Click the 'Weight Tracking' item in the main navigation to open the weight tracking page (element index 176).
        frame = context.pages[-1]
        # Click element
