...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the coach credentials and click the Sign In button.
        ...
        # -> Click the 'Manage Availability' button in the app navigation to open the Manage Availability page (element index 169).
        frame = context.pages[-1]
        # Click element
