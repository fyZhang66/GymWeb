...
async def run_test():
    ...
    try:
        ...
        # -> Fill the coach credentials into the email and password fields, then click the Sign In button to log in as the coach.
        ...
        # -> Click the 'Program Management' navigation item to navigate to the Program Management page and then verify the target URL and page title.
        frame = context.pages[-1]
        # Click element
