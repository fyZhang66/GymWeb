...
async def run_test():
    ...
    try:
        ...
        # -> Type the member credentials into the email and password fields and submit the login form (email -> index 7, password -> index 8, click Sign In -> index 11).
        ...
        assert await frame.locator('xpath=//*[contains(., "slot unavailable")]').nth(0).is_visible(), "Expected 'slot unavailable' to be visible"
