...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the coach credentials and click Sign In.
        ...
        # -> Click on the first member in the member list (John Member) to open the member details view.
        frame = context.pages[-1]
        # Click element
