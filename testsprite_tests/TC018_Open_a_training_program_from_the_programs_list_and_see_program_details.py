...
async def run_test():
    ...
    try:
        ...
        # -> Type the member credentials into the email and password fields and click Sign In (email -> index 7, password -> index 8, click Sign In -> index 11).
        ...
        # -> Click the 'Training Programs' navigation item to open the programs list (use interactive element index 175).
        frame = context.pages[-1]
        # Click element
