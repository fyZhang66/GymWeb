...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with member credentials and click the Sign In button to attempt authentication (then verify dashboard redirect and key summary content).
