...
async def run_test():
    ...
    try:
        ...
        # -> Fill the member credentials into the email and password fields and submit the form by clicking the Sign In button.
        ...
        # -> Click the 'Training Programs' menu item in the left navigation to navigate to the Programs page.
        frame = context.pages[-1]
        # Click element
